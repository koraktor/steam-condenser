...
public class L4DStats extends GameStats {

	private HashMap<String, Object> favorites;
	
	private HashMap<String, Object> lifetimeStats;
	
	private HashMap<String, Object> mostRecentGame;
	
	private HashMap<String, Object> survivalStats;
	
	private HashMap<String, Object> teamplayStats;
	
	private HashMap<String, Object> versusStats;
	
	private HashMap<String, GameWeapon> weaponStats;
